...
export async function getProviderStatsAction(): Promise<
...
export async function getQueryTypesAction(
...
export async function toggleQueryTypeAction(
  id: string,
